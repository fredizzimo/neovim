...
function M.skip_forced_multigrid_reattach()
  local reason = 'FIXME: reattaching or redrawing does not work with multigrid, #30582, #30583'
  M.skip_forced_mulitgrid(reason, nil, 3)
end

function M.skip_forced_multigrid_cmdline_offset()
  local reason = 'The experimental _cmdline_offset does not work with multigrid'
  M.skip_forced_mulitgrid(reason, nil, 3)
end
